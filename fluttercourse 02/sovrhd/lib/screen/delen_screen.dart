...
import 'gedeeld_screen.dart';

class DelenScreen extends StatelessWidget {
  const DelenScreen({Key? key}) : super(key: key);
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.of(context)
                            ...
                            return const GedeeldScreen.Bewijsstukgedeeld();
                          }));
                        },
                        child: Container(
                          height: 51,
