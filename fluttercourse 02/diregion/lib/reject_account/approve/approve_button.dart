...
import 'package:diregion/reject_account/approve/userapprove.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

import 'newsapprove.dart';

class Approve extends StatefulWidget {
  const Approve({Key? key}) : super(key: key);

  @override
  State<Approve> createState() => _Approve();
}

class _Approve extends State<Approve> with SingleTickerProviderStateMixin {
  List<Tab> tabs = [
    Tab(
      text: 'Users',
    ),
                ...
                Center(
                  child: Column(
                    children: [
                      ...
                      Text(
                        ' peter„has been successfully Approved',
                        style: TextStyle(
                            color: Color(0xFF000000),
                            fontWeight: FontWeight.bold),
                      ),
