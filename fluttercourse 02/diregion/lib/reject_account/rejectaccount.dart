...
import 'package:diregion/reject_account/tabbar/reject_acount_tabbar/reject_news.dart';
import 'package:diregion/reject_account/tabbar/reject_acount_tabbar/reject_user.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class RejectAccount extends StatefulWidget {
  const RejectAccount({Key? key}) : super(key: key);

  @override
  State<RejectAccount> createState() => _RejectAccount();
}

class _RejectAccount extends State<RejectAccount>
            ...
            child: Row(
              children: [
                Padding(
                  ...
                  child: Text(
                    'Ralf Hechler has been successfully rejected.',
                    style: TextStyle(
